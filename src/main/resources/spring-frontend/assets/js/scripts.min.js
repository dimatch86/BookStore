        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.price ? '<span class="Card-priceOld">₽' + book.price + '</span>\n' : '') + '                       <span class="Card-price">₽' + (book.price - book.price * book.discount/100) + '</span>\n' + '                </div>\n' + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
            ...
            return {
                init: function () {
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/books/bookReview/' + $this.data('bookid'), {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'authorbooks':
                                                sendData('/books/author/page/' + document.location.href.split('/').pop())
                                                break;
                                        }
                                    }
                                }
